...
public class AASeries {
  ...
  /**
   * 线条样式。只对包含线条的数据列类型有效，例如直线图、曲线图、面积图、线条宽度不为 0 的散点图等。
   *
   * @param prop 可用的线条类型包括： Solid，ShortDash，ShortDot，ShortDashDot，ShortDashDotDot，Dot，Dash，LongDash，DashDot，LongDashDot，LongDashDotDot
   */
  public AASeries dashStyle(String prop) {
    dashStyle = prop;
    return this;
  }
}
