...
import com.simuwang.aachart.chartenum.AAChartAnimationType;
import com.simuwang.aachart.chartenum.AAChartSymbolStyleType;
import com.simuwang.aachart.chartenum.AAChartType;
import com.simuwang.aachart.optionsmodel.AAAnimation;
import com.simuwang.aachart.optionsmodel.AABar;
import com.simuwang.aachart.optionsmodel.AAChart;
import com.simuwang.aachart.optionsmodel.AAColumn;
import com.simuwang.aachart.optionsmodel.AAColumnrange;
import com.simuwang.aachart.optionsmodel.AADataLabels;
import com.simuwang.aachart.optionsmodel.AAItemStyle;
import com.simuwang.aachart.optionsmodel.AALabels;
import com.simuwang.aachart.optionsmodel.AALegend;
import com.simuwang.aachart.optionsmodel.AAMarker;
import com.simuwang.aachart.optionsmodel.AAOptions;
import com.simuwang.aachart.optionsmodel.AAPie;
import com.simuwang.aachart.optionsmodel.AAPlotOptions;
import com.simuwang.aachart.optionsmodel.AASeries;
import com.simuwang.aachart.optionsmodel.AAStyle;
import com.simuwang.aachart.optionsmodel.AASubtitle;
import com.simuwang.aachart.optionsmodel.AATitle;
import com.simuwang.aachart.optionsmodel.AATooltip;
import com.simuwang.aachart.optionsmodel.AAXAxis;
import com.simuwang.aachart.optionsmodel.AAYAxis;
...
public class AAOptionsConstructor {
  public static AAOptions configureChartOptions(AAChartModel aaChartModel) {
    AAChart aaChart = new AAChart()
        ...
        .inverted(
            aaChartModel.inverted) //设置是否反转坐标轴，使X轴垂直，Y轴水平。 如果值为 true，则 x 轴默认是 倒置 的。 如果图表中出现条形图系列，则会自动反转
    ...
    AASubtitle aaSubtitle = new AASubtitle()
        ...
        .align(
            aaChartModel.subtitleAlign) //图表副标题文本水平对齐方式。可选的值有 “left”，”center“和“right”。 默认是：center.
  ...
  private static void configureAAPlotOptionsMarkerStyle(
    ...
    if (chartType.equals(AAChartType.Area)
      ...
      AAMarker aaMarker = new AAMarker()
          ...
          .symbol(
              aaChartModel.markerSymbol); //曲线点类型："circle", "square", "diamond", "triangle","triangle-down"，默认是"circle"
    ...
    switch (chartType) {
      ...
      case AAChartType.Columnrange:
        AAColumnrange aaColumnrange = new AAColumnrange()
            ...
            .borderWidth(0f)
            //The corner radius of the border surrounding each column or bar. default：0
            ;
