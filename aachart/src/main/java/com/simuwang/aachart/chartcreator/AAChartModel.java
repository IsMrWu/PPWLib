...
import com.simuwang.aachart.chartenum.AAChartStackingType;
import com.simuwang.aachart.chartenum.AAChartSymbolStyleType;
import com.simuwang.aachart.chartenum.AAChartType;
import com.simuwang.aachart.chartenum.AAChartZoomType;
import com.simuwang.aachart.optionsmodel.AAOptions;
import com.simuwang.aachart.optionsmodel.AAScrollablePlotArea;
...
public class AAChartModel {
  ...
  public AAChartModel() {
    ...
    colorsTheme =
        new String[] { "#fe117c", "#ffc069", "#06caf4", "#7dffc0" };//默认的颜色数组(必须要添加默认数组,否则就会出错)
